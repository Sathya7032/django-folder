...
__all__ = [
    'DISPID_SGRSTsCount', 'SITooSlow', 'ISpeechVoiceStatus',
    'eLEXTYPE_PRIVATE15', 'SPAO_NONE', 'SP_VISEME_6', 'SPCS_ENABLED',
    'DISPID_SOTGetStorageFileName', 'DISPID_SASNonBlockingIO',
    'SDTLexicalForm', 'DISPID_SMSGetData',
    'DISPID_SRCEPropertyNumberChange', 'SECFIgnoreWidth',
    'ISpeechRecoResult', 'SVP_0', 'SpeechAudioFormatType',
    'ISpeechPhraseAlternates', 'DISPID_SpeechBaseStream', 'SRARoot',
    'DISPID_SGRClear', 'eLEXTYPE_LETTERTOSOUND',
    ...
    'SPEI_SR_PRIVATE', 'SP_VISEME_0', 'SPPS_RESERVED2',
    ...
    'DISPID_SPRNumberOfElements', 'SPWORDPRONOUNCEABLE', 'SGLexical',
    'SPSFunction', 'ISpEventSink', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPAs_NewEnum', 'SVP_1', 'SRTEmulated', 'DISPID_SPPsItem',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE3',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_RESERVED9',
    'SPGRAMMARWORDTYPE', 'ISpStreamFormat', 'eLEXTYPE_PRIVATE4',
    'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_2', 'SAFT32kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SGRInitialState',
    'SPPHRASEPROPERTY', 'DISPID_SADefaultFormat', 'DISPID_SRProfile',
    'SVEStartInputStream', 'DISPID_SPCPhoneToId', 'SPEI_HYPOTHESIS',
    'SRSInactiveWithPurge', 'STSF_AppData', 'Speech_Default_Weight',
    'SRTReSent', 'ISpRecoGrammar2', 'SAFTCCITT_uLaw_8kHzStereo',
    'SVSFlagsAsync', 'SECNormalConfidence', 'SpeechTokenKeyUI',
    'ISpeechMMSysAudio', 'DISPID_SGRSTransitions',
    'DISPID_SASetState', 'DISPID_SPEDisplayText', 'SREStreamStart',
    'SAFT16kHz16BitStereo', 'SPFM_OPEN_READWRITE', 'SP_VISEME_16',
    'SpeechTokenShellFolder', 'DISPID_SRSAudioStatus',
    'ISpeechLexiconWord', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SVStatus', 'SRSEIsSpeaking', 'SAFTExtendedAudioFormat',
    'DISPID_SDKGetStringValue', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPAsItem', 'ISpPhraseAlt', 'SpNotifyTranslator',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SLWs_NewEnum',
    'DISPID_SOTSetId', 'SpeechGrammarRuleStateTransitionType',
    'SPSNoun', 'DISPID_SpeechLexiconPronunciation', 'SPCS_DISABLED',
    'eLEXTYPE_PRIVATE6', 'SREAdaptation', 'SWPKnownWordPronounceable',
    'SPAR_Unknown', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRGCmdLoadFromObject', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SDKOpenKey', 'ISpeechCustomStream',
    'ISpPhoneticAlphabetConverter', 'DISPID_SGRAddState',
    'DISPID_SRCESoundStart', 'SVP_11', 'ISpeechObjectTokens',
    'eLEXTYPE_RESERVED8', 'ISpNotifySource', 'SpeechAudioVolume',
    'SPSVerb', 'DISPID_SBSRead', 'SVSFParseSapi',
    'DISPID_SPEActualConfidence', 'SVSFVoiceMask',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechRegistryLocalMachineRoot',
    'SVP_7', 'ISpShortcut', 'SP_VISEME_11', 'SPWORDPRONUNCIATION',
    'SAFT48kHz8BitMono', 'SPEI_MAX_TTS', 'SVP_3',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechMemoryStream',
    'ISpeechPhraseProperty', 'DISPID_SPAStartElementInResult',
    'tagSPPROPERTYINFO', 'DISPID_SpeechVoice', 'SPBO_AHEAD',
    'DISPID_SpeechXMLRecoResult', 'ISpeechPhraseElement',
    'ISpMMSysAudio', 'SVEWordBoundary', 'SpeechFormatType',
    'DISPID_SPRsCount', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechLexiconWords', 'DISPID_SLPsItem',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SDKEnumValues',
    'DISPID_SGRsDynamic', 'SpMMAudioIn', 'SVEViseme',
    'SpeechDisplayAttributes', 'DISPID_SpeechRecoResult',
    'DISPID_SpeechPhraseRules', 'SRSActive', 'SREStreamEnd',
    'SVF_Stressed', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRSNumberOfActiveRules', 'ISpNotifyTranslator',
    'ISpRecognizer3', 'DISPID_SDKSetBinaryValue', 'SVP_16',
    'SAFTCCITT_uLaw_11kHzStereo', 'SSFMCreateForWrite',
    'SAFT12kHz16BitStereo', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechCustomStream', 'SPCT_SUB_DICTATION',
    'DISPID_SPRulesItem', 'SVSFParseSsml', 'SAFTGSM610_11kHzMono',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechVoiceStatus',
    'SVSFPersistXML', 'SREInterference',
    'DISPID_SGRSAddRuleTransition',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRStatus',
    'SLTApp', 'DISPID_SPRuleConfidence', 'DISPID_SRGRecoContext',
    'DISPID_SWFEExtraData', 'SVP_10', 'eLEXTYPE_PRIVATE8',
    'SSTTWildcard', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_14',
    'DISPID_SLWsItem', 'DISPID_SRGRules', 'ISpeechGrammarRules',
    'SAFTDefault', 'SAFTCCITT_uLaw_22kHzStereo',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCEEnginePrivate',
    'SPSTREAMFORMATTYPE', 'DISPID_SRRSaveToMemory',
    ...
    'SVEAudioLevel', 'DISPIDSPTSI', 'SRAImport', 'DISPID_SOTCDefault',
    'SDTAlternates', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SOTCategory', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SOTRemove',
    'Speech_StreamPos_Asap', 'SRSEDone', 'SpeechGrammarTagWildcard',
    'DISPID_SOTCId', 'SpPhraseInfoBuilder',
    'DISPID_SRGCmdLoadFromResource', 'SPWORDLIST', 'DISPID_SLWsCount',
    'DISPID_SRAudioInputStream', 'tagSPTEXTSELECTIONINFO',
    'SpeechGrammarTagDictation', 'SpeechAudioState',
    'SECFIgnoreKanaType', 'DISPID_SRCESoundEnd', 'DISPID_SGRName',
    'DISPID_SGRSRule', 'SAFTCCITT_uLaw_8kHzMono', 'SREAudioLevel',
    'ISpeechAudio', 'SPSHORTCUTPAIRLIST', 'SPEI_ADAPTATION',
    'SPAUDIOBUFFERINFO', 'SVSFIsFilename', 'SAFT11kHz16BitMono',
    'SPRECOCONTEXTSTATUS', 'SVEVoiceChange', 'DISPID_SAVolume',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPRulesCount',
    'SVP_4', 'SPAO_RETAIN_AUDIO', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SpeechGrammarRules', 'DISPID_SRRAudioFormat',
    'SPRS_ACTIVE', 'SVP_15', 'SpeechEmulationCompareFlags',
    'SVF_Emphasis', 'DISPID_SPRuleId',
    'ISpeechGrammarRuleStateTransitions', 'SAFT32kHz8BitStereo',
    'SpeechTokenKeyFiles', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT24kHz16BitMono', 'SAFTADPCM_22kHzMono', 'ISpNotifySink',
    'SPRULE', 'SPBINARYGRAMMAR', 'DISPID_SpeechGrammarRule',
    'DISPID_SVVolume', 'Speech_Max_Word_Length', 'ISpResourceManager',
    'DISPID_SVSkip', 'SVP_8', 'SpMMAudioEnum', 'SVPOver',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTIsUISupported',
    'SPPARTOFSPEECH', 'SAFTCCITT_ALaw_11kHzMono', 'SPBO_PAUSE',
    'DISPID_SRCVoicePurgeEvent', 'SAFT22kHz16BitMono', 'SP_VISEME_9',
    'SPFM_CREATE', 'ISpeechPhraseInfo', 'DISPID_SGRsCount',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPLO_STATIC', 'ISpRecoContext',
    'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_20', 'DISPID_SOTsItem',
    'DISPID_SpeechObjectTokens', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpStreamFormatConverter', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVGetProfiles', 'SPEI_TTS_BOOKMARK', 'SPRECOGNIZERSTATUS',
    'SpeechEngineProperties', 'ISpeechPhraseReplacements',
    'eLEXTYPE_USER', 'SPEI_RESERVED1', 'eLEXTYPE_RESERVED4',
    'DISPID_SPPValue', 'DISPID_SLGenerationId', 'DISPID_SVEBookmark',
    'SDA_No_Trailing_Space', 'SPPS_SuppressWord',
    'STSF_CommonAppData', 'ISpPhrase', 'SpeechPartOfSpeech',
    'SpObjectToken', 'SVEPrivate', 'SITooLoud',
    'DISPID_SWFEBitsPerSample', 'SAFT32kHz8BitMono',
    'SpeechInterference', 'SPVPRIORITY', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SOTsCount', 'SPSMF_UPS',
    'DISPID_SpeechPhraseReplacements', 'SVSFUnusedFlags',
    'SGLexicalNoSpecialChars', 'SPSUnknown', 'DISPID_SRState',
    'SGSDisabled', 'SDKLLocalMachine', 'DISPID_SPIReplacements',
    'SRTStandard', 'DISPID_SRCState', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRRAudio', 'DISPID_SRCEInterference',
    'SpeechCategoryRecognizers', 'STCRemoteServer',
    'DISPID_SPRDisplayAttributes', 'SPPHRASEELEMENT',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRCRetainedAudio',
    'SP_VISEME_1', 'DISPID_SpeechMMSysAudio', 'SpAudioFormat',
    'SGRSTTEpsilon', 'SBONone', 'SPVPRI_ALERT', 'SpeechVisemeType',
    'SASPause', 'SPRS_INACTIVE', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPIAudioStreamPosition', 'SRCS_Enabled', 'DISPID_SLWWord',
    'SpeechStreamFileMode', 'SPSLMA', 'ISpLexicon', 'SLTUser',
    'SPEI_RESERVED2', 'SREPropertyStringChange',
    'DISPID_SOTRemoveStorageFileName', 'SAFT16kHz8BitMono',
    'ISpeechVoice', 'SpeechRecognitionType', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTADPCM_8kHzMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_19',
    'ISpPhoneticAlphabetSelection', 'SAFT44kHz8BitMono',
    'SDKLCurrentConfig', 'SPPS_Verb', 'DISPID_SGRSTPropertyValue',
    'SSTTDictation', 'SVSFIsNotXML', 'SpeechDiscardType',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRsItem',
    'DISPID_SPRuleParent', 'SPSNotOverriden', 'DISPID_SPPs_NewEnum',
    'SVEAllEvents', 'SINone', 'SpeechVoicePriority', 'SPPHRASE',
    'SPPHRASEREPLACEMENT', 'SAFT48kHz16BitStereo',
    'DISPID_SABufferInfo', 'SPEI_PHRASE_START', 'SPGRAMMARSTATE',
    'DISPID_SpeechObjectToken', 'SDTPronunciation',
    'SECLowConfidence', 'SPEI_MIN_SR', 'SPDKL_CurrentConfig',
    'SREAllEvents', 'DISPID_SPCLangId', 'SPAR_Medium', 'STCAll',
    'STSF_FlagCreate', 'SPLO_DYNAMIC', 'DISPID_SVEVoiceChange',
    'DISPID_SRSetPropertyString', 'SpeechEngineConfidence',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCResume',
    'DISPID_SDKDeleteKey', 'DISPID_SAFGuid', 'DISPID_SPIEngineId',
    'ISpObjectToken', 'DISPID_SpeechGrammarRuleStateTransitions',
    'STCInprocServer', 'DISPID_SVSRunningState',
    'SDA_One_Trailing_Space', 'SAFTADPCM_8kHzStereo',
    'SpMemoryStream', 'Speech_Max_Pron_Length', 'DISPID_SOTs_NewEnum',
    'SPLEXICONTYPE', 'DISPID_SPIStartTime', 'DISPID_SLPLangId',
    'DISPID_SpeechDataKey', 'DISPID_SLWType',
    'DISPID_SRGetPropertyString', 'DISPID_SOTCGetDataKey',
    'DISPID_SAFType', 'DISPID_SRCERecognitionForOtherContext',
    'SAFT44kHz16BitStereo', 'SP_VISEME_21',
    'DISPID_SpeechPhraseProperties', 'SpeechRecoEvents',
    'DISPID_SRCSetAdaptationData', 'DISPID_SMSALineId',
    'DISPID_SRSCurrentStreamPosition', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechPhraseInfoBuilder', 'SPINTERFERENCE_NOSIGNAL', 'SWTAdded',
    'DISPID_SDKDeleteValue', 'SpeechCategoryAudioOut',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCCreateResultFromMemory',
    'SAFT22kHz8BitStereo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTGSM610_44kHzMono', 'SGSExclusive',
    'SpPhoneticAlphabetConverter', 'ISpRecoCategory',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVSLastBookmark',
    'SP_VISEME_18', 'SPDKL_DefaultLocation',
    'SpeechAudioFormatGUIDWave', 'SITooQuiet',
    'DISPID_SVWaitUntilDone', 'eLEXTYPE_PRIVATE16', 'SPVPRI_OVER',
    'DISPID_SpeechFileStream', 'SPEI_UNDEFINED', 'SPPS_LMA',
    'ISpeechPhraseProperties', 'DISPID_SVAudioOutputStream',
    'SPAR_High', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVSInputSentenceLength', 'SPGS_DISABLED', 'SPAS_CLOSED',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVIsUISupported',
    'DISPID_SVPriority', 'SpeechWordPronounceable', 'SPPS_Noun',
    'SPSHORTCUTPAIR', 'SPWT_DISPLAY', 'eWORDTYPE_DELETED',
    'DISPID_SRRTLength', 'DISPID_SRDisplayUI', 'SVESentenceBoundary',
    'DISPID_SGRSTPropertyName', 'DISPID_SRCBookmark',
    'SPINTERFERENCE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechPhoneConverter', 'SpeechCategoryVoices',
    'ISpeechPhraseReplacement', 'DISPID_SpeechMemoryStream',
    'SPAS_PAUSE', 'SPWT_PRONUNCIATION', 'DISPID_SPPParent',
    'DISPID_SPRText', 'DISPID_SRCreateRecoContext',
    'DISPID_SAFSetWaveFormatEx', 'SSFMOpenReadWrite', 'SPWT_LEXICAL',
    'SPAUDIOOPTIONS', 'DISPID_SpeechPhraseAlternates',
    'SPEI_SOUND_START', 'SPEI_SOUND_END', 'DISPID_SPPChildren',
    'SECFEmulateResult', 'ISpeechLexiconWords', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRCVoice', 'SpStream', 'SPLOADOPTIONS', 'SGRSTTRule',
    'SAFT16kHz8BitStereo', 'SAFT48kHz8BitStereo',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRGetFormat',
    'SPINTERFERENCE_NONE', 'eLEXTYPE_APP', 'DISPID_SGRSTWeight',
    'SPEI_MAX_SR', 'DISPID_SPIGrammarId', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPEAudioStreamOffset', 'SINoSignal', 'SVSFNLPMask',
    'DISPID_SFSClose', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPCIdToPhone', 'SpeechPropertyLowConfidenceThreshold',
    'SPRULESTATE', 'ISpeechPhraseRules', 'SAFT48kHz16BitMono',
    'SPEI_RESERVED3', 'SVP_2', 'DISPID_SOTDataKey',
    'ISpeechAudioStatus', 'DISPID_SPIGetText', 'SpMMAudioOut',
    'STCLocalServer', 'SVPAlert', 'SVEBookmark',
    ...
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechBaseStream', 'DISPID_SMSSetData', 'DISPID_SRRTimes',
    'SREPropertyNumChange', 'SPDKL_CurrentUser',
    'SAFT24kHz16BitStereo', 'SVSFPurgeBeforeSpeak',
    'SPSEMANTICFORMAT', 'DISPID_SWFEFormatTag', 'SPXRO_SML',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechPhraseElements',
    'SRESoundEnd', 'ISpVoice', 'DISPID_SPIEnginePrivateData',
    'SPWAVEFORMATTYPE', 'DISPID_SRGReset', 'SPPS_RESERVED3',
    'SPEI_WORD_BOUNDARY', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_21',
    'SWPUnknownWordUnpronounceable', 'DISPID_SDKEnumKeys', 'SASRun',
    'SP_VISEME_8', 'DISPID_SRRSpeakAudio', 'SRAInterpreter',
    ...
    'DISPID_SASState', 'ISpStream', 'STCInprocHandler',
    'SPEI_RESERVED5', 'SP_VISEME_5', 'SpeechTokenValueCLSID',
    'SPPS_Interjection', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SLGetPronunciations',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SWFEBlockAlign',
    'DISPID_SPELexicalForm', 'ISpRecoGrammar', 'SPRST_NUM_STATES',
    'DISPID_SRCERequestUI', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechMicTraining', 'SAFTADPCM_11kHzStereo',
    'SAFTGSM610_8kHzMono', 'SRADynamic', 'DISPID_SDKSetStringValue',
    'SP_VISEME_17', 'SpCustomStream', 'DISPID_SRCRequestedUIType',
    'SPFM_CREATE_ALWAYS', 'SREStateChange', 'DISPID_SpeechVoiceEvent',
    'SFTSREngine', 'SVSFNLPSpeakPunc', 'SAFT24kHz8BitMono',
    'SPEI_INTERFERENCE', 'SPFILEMODE', 'DISPID_SVSInputWordPosition',
    'SpeechSpecialTransitionType', 'SRAORetainAudio',
    'SPSEMANTICERRORINFO', 'SSSPTRelativeToStart',
    'DISPID_SRSClsidEngine', 'SLOStatic', 'DISPID_SBSWrite',
    'SSFMOpenForRead', 'DISPID_SVSInputSentencePosition',
    'SPCONTEXTSTATE', 'SGDSActive', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVEventInterests', 'DISPID_SRCEPhraseStart', 'SFTInput',
    'SPDATAKEYLOCATION', 'SpeechRuleAttributes', 'ISpProperties',
    'DISPID_SPRuleNumberOfElements', 'SpeechVisemeFeature',
    'DISPID_SVEWord', 'SPVOICESTATUS', 'ISpeechLexiconPronunciation',
    'SREFalseRecognition', 'SREPrivate',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVVoice',
    'SRTAutopause', 'SpShortcut', 'DISPID_SVSPhonemeId',
    'SAFT16kHz16BitMono', 'SDTAll', 'SREBookmark', 'ISpeechDataKey',
    'SpeechPropertyAdaptationOn', 'ISpeechPhraseRule',
    'ISpeechWaveFormatEx', 'SpCompressedLexicon', 'SPBO_TIME_UNITS',
    'SPCATEGORYTYPE', 'ISpRecoContext2', 'IStream',
    'SPINTERFERENCE_NOISE', 'SPPHRASERULE', 'SAFT44kHz16BitMono',
    'DISPID_SPPsCount', 'SpInprocRecognizer', 'SVP_13',
    ...
    'SP_VISEME_7', 'eLEXTYPE_PRIVATE5', 'SPEI_SR_BOOKMARK',
    'SAFTCCITT_ALaw_8kHzMono', 'eLEXTYPE_PRIVATE18', 'SPPS_Modifier',
    'DISPID_SLPsCount', 'SAFTCCITT_uLaw_11kHzMono', 'ISpDataKey',
    'SRSActiveAlways', 'DISPID_SRCPause', 'SLODynamic',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SREmulateRecognition',
    'SRCS_Disabled', 'SpeechRecoContextState',
    'DISPID_SRGetPropertyNumber', 'SAFT8kHz16BitStereo',
    'DISPID_SRCEStartStream', 'IEnumSpObjectTokens',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVSpeakCompleteEvent', 'eLEXTYPE_RESERVED7',
    'DISPID_SDKSetLongValue', 'SPVISEMES', 'DISPID_SVSpeakStream',
    'DISPID_SGRSTText', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SLPSymbolic', 'LONG_PTR', 'DISPID_SVSLastResult',
    'eLEXTYPE_RESERVED10', 'SPAUDIOSTATUS', 'SVP_12',
    'DISPID_SPERetainedSizeBytes', 'SAFT11kHz8BitMono', 'SPBO_NONE',
    'DISPID_SVSLastBookmarkId', 'SDTProperty', 'SPSModifier',
    'SPPS_Unknown', 'DISPID_SPEsItem', 'ISpEventSource',
    'SPDKL_LocalMachine', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SGRAttributes',
    'DISPID_SABIEventBias', 'ISpGrammarBuilder',
    'DISPID_SPIAudioSizeTime', 'ISpSerializeState',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRSTNextState',
    'SRTSMLTimeout', 'DISPID_SPEs_NewEnum', 'SINoise',
    'SPXMLRESULTOPTIONS', 'DISPID_SLGetGenerationChange',
    'DISPID_SPRuleName', 'SPEI_RESERVED6', '_SPAUDIOSTATE',
    'SpInProcRecoContext', 'DISPID_SPERetainedStreamOffset',
    'SPAUDIOSTATE', 'WAVEFORMATEX', 'DISPID_SRCERecognition',
    'SP_VISEME_4', 'DISPID_SPRs_NewEnum', 'SPWF_INPUT',
    'ISpeechPhraseAlternate', 'SGDSActiveWithAutoPause',
    'SSSPTRelativeToEnd', 'DISPID_SPRuleChildren',
    'DISPID_SASFreeBufferSpace', 'DISPID_SGRSTsItem',
    'DISPID_SDKGetBinaryValue', 'DISPID_SpeechPhraseInfo', 'SVP_9',
    'SRSInactive', 'SpeechLoadOption', 'DISPID_SRRAlternates',
    'SpeechRunState', 'DISPID_SRRecognizer',
    'DISPID_SRRSetTextFeedback', 'DISPID_SBSFormat',
    'SpeechVoiceSpeakFlags', 'ISpeechRecognizer',
    'DISPID_SLRemovePronunciation', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVP_20', 'SpSharedRecognizer', 'DISPID_SpeechRecoContextEvents',
    'SP_VISEME_12', 'STSF_LocalAppData', 'SGPronounciation',
    'ISpeechPhoneConverter', 'DISPID_SLGetWords',
    'SRADefaultToActive', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRRTStreamTime', 'DISPID_SABIBufferSize', 'SPWF_SRENGINE',
    'ISpeechObjectToken', 'SDKLCurrentUser',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechLexiconWord',
    'DISPID_SRSCurrentStreamNumber', 'eLEXTYPE_PRIVATE10',
    'SPRST_INACTIVE', 'eLEXTYPE_PRIVATE17', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechRecognizer', 'SpSharedRecoContext',
    'DISPID_SpeechRecoContext', 'DISPID_SVDisplayUI', 'SVP_18',
    'SpStreamFormatConverter', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPERequiredConfidence', 'DISPID_SRSetPropertyNumber',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT12kHz8BitMono',
    'DISPID_SLWPronunciations', 'SAFT8kHz8BitMono',
    'DISPID_SRGCmdSetRuleState', 'ISpeechXMLRecoResult',
    ...
    'DISPID_SPPFirstElement', 'DISPID_SRCRecognizer',
    'DISPID_SVEAudioLevel', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechRecoResult2', 'DISPID_SRRRecoContext',
    'SpeechAllElements', 'SPEVENTSOURCEINFO', 'DISPID_SLPPhoneIds',
    'eLEXTYPE_PRIVATE20', 'SPEI_START_INPUT_STREAM',
    'DISPID_SCSBaseStream', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SGRsItem', 'DISPID_SRCEEndStream', 'DISPID_SRCEBookmark',
    'DISPID_SOTCSetId', 'SWTDeleted', 'SpeechRuleState',
    'SPSERIALIZEDRESULT', 'SBOPause', 'ISpObjectTokenCategory',
    'DISPID_SVGetAudioOutputs', 'eLEXTYPE_RESERVED6',
    '_ISpeechVoiceEvents', 'DISPID_SVAudioOutput',
    'SpTextSelectionInformation', 'SPEVENT', 'SAFTNonStandardFormat',
    'SPWORDTYPE', 'SECHighConfidence', 'SPEI_VOICE_CHANGE',
    'DISPID_SLPType', 'SPADAPTATIONRELEVANCE', 'IEnumString',
    'SVSFDefault', 'DISPID_SRRTOffsetFromStart', 'ISpRecognizer2',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechLexiconProns',
    'SAFTText', 'DISPID_SRRTTickCount',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRsCommit', 'eLEXTYPE_PRIVATE9', 'SPRST_ACTIVE_ALWAYS',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPCT_SLEEP',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPPNumberOfElements', 'DISPID_SRIsShared', 'DISPID_SOTId',
    'DISPID_SABIMinNotification', 'SPRECOSTATE',
    'Speech_StreamPos_RealTime', 'SAFT11kHz8BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'ISpeechGrammarRule', 'SPSHT_OTHER',
    'SpeechDataKeyLocation', 'SPAS_RUN', 'SPEI_MIN_TTS',
    'DISPID_SMSADeviceId', 'eLEXTYPE_USER_SHORTCUT', 'SpWaveFormatEx',
    'DISPID_SOTDisplayUI', 'DISPID_SFSOpen', 'SPEI_TTS_PRIVATE',
    'SRATopLevel', 'eWORDTYPE_ADDED', 'SP_VISEME_15',
    'SpeechDictationTopicSpelling', 'SRAExport',
    ...
    'DISPID_SDKGetlongValue', 'SP_VISEME_13',
    'DISPID_SRCEventInterests', 'DISPID_SPPEngineConfidence',
    'DISPID_SRGIsPronounceable', 'SAFT44kHz8BitStereo', 'SVF_None',
    'SAFTADPCM_22kHzStereo', 'SpeechTokenKeyAttributes',
    'SpPhoneConverter', 'SP_VISEME_10', 'DISPID_SRGDictationSetState',
    'SpeechLexiconType', 'SPEI_PHONEME', 'DISPID_SRCCreateGrammar',
    'SAFT22kHz8BitMono', 'ISpeechRecoResultTimes',
    'SpeechTokenContext', 'SPGS_ENABLED',
    'DISPID_SRCEPropertyStringChange', 'ISpeechRecoContext',
    'SAFT8kHz16BitMono', 'SGDisplay', 'SPEVENTENUM', 'SECFIgnoreCase',
    'SpUnCompressedLexicon', 'SVEPhoneme', 'DISPID_SVRate',
    'SPSHT_EMAIL', 'SREPhraseStart', 'DISPID_SPEsCount',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechRecoResult2', 'DISPID_SRGetRecognizers',
    'SPVPRI_NORMAL', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechFileStream', 'SAFTCCITT_uLaw_22kHzMono', 'SVPNormal',
    'DISPID_SRIsUISupported', 'SPGS_EXCLUSIVE',
    'DISPID_SpeechPhraseElements', 'SECFDefault',
    'DISPID_SPEEngineConfidence', 'SPXRO_Alternates_SML',
    'SPRECORESULTTIMES', 'SGRSTTDictation', 'SpeechRecognizerState',
    'DISPID_SPILanguageId', 'DISPID_SAStatus',
    'DISPID_SPEAudioSizeBytes', 'SVP_19', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPEDisplayAttributes',
    'ISequentialStream', 'ISpeechAudioBufferInfo',
    'ISpObjectWithToken', 'SSFMCreate', 'SRERecoOtherContext',
    'DISPID_SPPConfidence', 'IInternetSecurityManager', 'SASStop',
    'SpeechCategoryRecoProfiles', 'SRAONone', 'DISPID_SRCEAudioLevel',
    'DISPID_SVSVisemeId', 'SPSSuppressWord', 'DISPID_SPACommit',
    'DISPID_SOTCreateInstance', 'tagSTATSTG', 'DISPID_SGRsFindRule',
    'SSTTTextBuffer', 'SAFT8kHz8BitStereo', 'eLEXTYPE_PRIVATE2',
    'DISPID_SBSSeek', 'SPPS_Noncontent',
    'SpeechPropertyComplexResponseSpeed', 'SpeechRegistryUserRoot',
    'SDA_Consume_Leading_Spaces', 'SpeechWordType', 'SPPROPERTYINFO',
    'SDKLDefaultLocation', 'DISPID_SPIProperties',
    'DISPID_SPIElements', 'SPEI_VISEME', 'SPAS_STOP',
    'SPEI_END_SR_STREAM', 'DISPID_SVResume', 'DISPID_SGRs_NewEnum',
    'DISPID_SPAsCount', 'DISPID_SpeechAudioBufferInfo',
    'SECFNoSpecialChars', 'SpNullPhoneConverter', 'SDTDisplayText',
    'SAFT11kHz16BitStereo', 'DISPID_SVEStreamEnd',
    'SAFT32kHz16BitMono', 'DISPID_SVEViseme', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechAudioFormat',
    '_ISpeechRecoContextEvents', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SMSAMMHandle', 'DISPID_SRGDictationLoad',
    'SPPS_RESERVED1', 'SVP_6', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechAudioStatus', 'DISPID_SPAPhraseInfo',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechCategoryAudioIn',
    'DISPIDSPRG', 'SPSHT_NotOverriden', 'SpeechUserTraining',
    'SPCT_DICTATION', 'ISpPhoneConverter', 'SpVoice',
    'DISPID_SLPs_NewEnum', 'SpeechAudioProperties',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTType', 'SP_VISEME_14',
    'DISPID_SRGState', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_VENDORLEXICON', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVPause', 'SpeechBookmarkOptions', 'DISPID_SLWLangId',
    'SPPS_RESERVED4', '_RemotableHandle',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechPhraseReplacement',
    'SPEI_REQUEST_UI', 'SDTRule', 'SVP_5', 'SRESoundStart',
    'SREHypothesis', 'DISPID_SPPId', 'SPSERIALIZEDPHRASE',
    'SpeechTokenIdUserLexicon', 'SPWORD',
    'SpeechStreamSeekPositionType', 'DISPID_SPARecoResult',
    'SAFTNoAssignedFormat', 'SPRST_ACTIVE', 'ISpeechResourceLoader',
    'ISpeechGrammarRuleState', 'DISPID_SPPName', 'SPSHT_Unknown',
    'DISPID_SRRGetXMLResult', 'SPCT_SUB_COMMAND', 'ISpAudio',
    ...
    'SPCT_COMMAND', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRId',
    'SpeechCategoryAppLexicons', '__MIDL_IWinTypes_0009',
    'SAFT22kHz16BitStereo', 'SGRSTTWord', 'SVSFParseAutodetect',
    'ISpRecoResult', 'SGRSTTTextBuffer', 'SITooFast', 'SGSEnabled',
    'SP_VISEME_3', 'SPSInterjection', 'DISPID_SVAlertBoundary',
    'SDTReplacement', 'SPINTERFERENCE_TOOFAST', 'SVEEndInputStream',
    ...
    'eLEXTYPE_PRIVATE12', 'SPTEXTSELECTIONINFO', 'ISpRecognizer',
    'DISPID_SPEPronunciation', 'SPAR_Low', 'SRERecognition',
    'SpeechGrammarWordType', 'ISpeechLexiconPronunciations',
    'SpeechVoiceEvents', 'DISPID_SVSInputWordLength',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRGId',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SVSpeak', 'UINT_PTR',
    'DISPID_SRSSupportedLanguages', 'ISpeechAudioFormat', 'SVP_17',
    'SPFM_NUM_MODES', 'DISPID_SGRSTRule', 'SPSMF_SAPI_PROPERTIES',
    'SDTAudio', 'SPFM_OPEN_READONLY', 'ISpeechRecoGrammar',
    'SVSFIsXML', 'SPPS_NotOverriden', 'DISPID_SRGSetTextSelection',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_RECOGNITION',
    'SPEI_START_SR_STREAM', 'SpResourceManager', 'DISPID_SGRsAdd',
    'DISPID_SGRAddResource', 'SGDSInactive', 'SPSHORTCUTTYPE',
    'SRTExtendableParse', 'DISPID_SVEStreamStart',
    'SpObjectTokenCategory'
]

_check_version('1.2.0', 1700149850.376712)
